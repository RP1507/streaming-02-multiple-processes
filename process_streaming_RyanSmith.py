...
INPUT_FILE_NAME = "AMZN_DailyClosingsHistory.csv"
        ...
        with open(output_file_name, "w", newline="") as output_file:
            ...
            for row in reader:
               ...
               # Date, Open, High, Low, Close, AdjClose, Volume = row
                ...
                #writer.writerow([Date, Open, High, Low, Close, AdjClose, Volume]) --- Wanted to try and write the message from the terminal to the .csv
                writer.writerow([(f"Sent: {MESSAGE} on port {PORT}. Hit CTRL-c to stop.")])
                time.sleep(3)
